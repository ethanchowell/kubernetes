      ...
      tf.Client = &fake.RESTClient{
        ...
        Client: fake.CreateHTTPClient(func(req *http.Request) (*http.Response, error) {
          ...
          case p == "/api/v1/namespaces/"+testNS+"/pods":
            body, _ := marshallBody(testV1PodData())
...
func testV1PodData() *v1.PodList {
  return &v1.PodList{
    ...
    Items: []v1.Pod{
      {
        ObjectMeta: metav1.ObjectMeta{Name: "pod1", Namespace: "testNs", ResourceVersion: "10"},
        Spec: v1.PodSpec{
          ...
          Containers: []v1.Container{
            {
              ...
              Resources: v1.ResourceRequirements{
                Requests: v1.ResourceList{
                  v1.ResourceCPU:    *resource.NewMilliQuantity(1, resource.DecimalSI),
                  v1.ResourceMemory: *resource.NewQuantity(1*(1024*1024), resource.DecimalSI),
                },
      ...
      {
        ObjectMeta: metav1.ObjectMeta{Name: "pod2", Namespace: "testNs", ResourceVersion: "11"},
        Spec: v1.PodSpec{
          RestartPolicy:                 v1.RestartPolicyAlways,
          DNSPolicy:                     v1.DNSClusterFirst,
          TerminationGracePeriodSeconds: &grace,
          ...
          Containers: []v1.Container{
            ...
            },
            {
              ...
              Resources: v1.ResourceRequirements{
                ...
                Limits: v1.ResourceList{
                  v1.ResourceCPU:    *resource.NewMilliQuantity(15, resource.DecimalSI),
                  v1.ResourceMemory: *resource.NewQuantity(15*(1024*1024), resource.DecimalSI),
                },
              },
            },
            {
      ...
      {
        ObjectMeta: metav1.ObjectMeta{Name: "pod3", Namespace: "testNs", ResourceVersion: "9"},
        Spec: v1.PodSpec{
          RestartPolicy:                 v1.RestartPolicyAlways,
          DNSPolicy:                     v1.DNSClusterFirst,
          TerminationGracePeriodSeconds: &grace,
